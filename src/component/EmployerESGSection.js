      ...
      <div className='w-2/3 h-full flex '>
        <div className='flex h-full flex-col gap-8 w-1/2 pt-32'>
          ...
          <p className='font-medium text-xl leading-[33px] w-5/6'>
            iMe actively promotes staff well-being and burnout reduction, in
            line with business sustainability efforts and meeting ESG standards
            and CSRD. By promoting a healthy, balanced workplace, the platform
            assists firms in demonstrating a commitment to social responsibility
            and long-term employee care.
          </p>
        </div>
