      ...
      <div className='w-3/4 h-[25rem] rounded-[2.5rem] flex  gap-8  bg-theme-gradient '>
        <div className='w-1/2 flex flex-col p-10 gap-8'>
          ...
          <p className='text-xl font-medium text-white leading-5'>
            Empower your workforce with AI-driven well-being management and
            work-life harmony solution. From real-time insights to proactive
            well-being support, transform your workplace for optimal
        ...
        <Image
          ...
          width={100}
          height={100}
          className='w-[32.25rem] h-[40.12rem] relative -top-16 left-20'
        />
      </div>
    </div>
  );
